...
class ExtractDates
{
    static void Main()
    {
        string text = @"I was born at 03.01.1976. My sister was born at 3.7.1984. In 5/1999 I graduated my high school. The law says (see section 7.3.12) that we are allowed to do this (section 7.4.2.9).";
